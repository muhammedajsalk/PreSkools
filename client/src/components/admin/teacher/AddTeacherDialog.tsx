        ...
        <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth TransitionComponent={Fade} PaperProps={{ sx: { borderRadius: 4 } }}>
            ...
            <DialogContent sx={{ p: 3, pt: 1 }}>
                ...
                <Stack spacing={3}>
                    ...
                    <TextField label="Phone Number" placeholder='Ex:919999999999' value={form.phone} onChange={(e) => setForm({ ...form, phone: e.target.value.replace(/\D/g, '').slice(0, 12) })} fullWidth required InputProps={{ startAdornment: <InputAdornment position="start"><Phone sx={{ color: 'text.secondary' }} /><Typography sx={{ ml: 1, fontWeight: 500 }}></Typography></InputAdornment> }} />
